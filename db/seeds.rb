...
5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id:1 )
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 2)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 3)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 4)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 5)
end

 5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 6)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 7)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 8)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 9)
end

5.times do 
    Review.create(comment:Faker::Quotes::Shakespeare.hamlet_quote, title:Faker::Verb.past_participle, diet_id: 10)
end